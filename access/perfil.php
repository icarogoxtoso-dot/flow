...
try {
    ...
    error_log('DB error em perfil.php: ' . $e->getMessage());
...
if (!empty($pro['tags'])) {
    ...
    $fromJson = json_decode((string) ($pro['servicos'] ?? $pro['serviços'] ?? $pro['serviÃ§os'] ?? '[]'), true);
            ...
            <div class="flex flex-col md:flex-row gap-5 md:gap-6 items-start">
                ...
                <div class="flex-1 space-y-3 w-full min-w-0">
                    ...
                    <div class="flex flex-wrap gap-2 pt-2 justify-center md:justify-start">
                        <?php foreach ($especialidades as $servico): ?>
                            <span class="service-badge"><?php echo htmlspecialchars($servico, ENT_QUOTES, 'UTF-8'); ?></span>
                        <?php endforeach; ?>
                    </div>
                            ...
                            <div id="work-gallery" class="gallery-grid">
                                <?php foreach ($fotos_trabalho as $idx => $foto): ?>
                                    <button
                                        ...
                                        data-image-alt="Trabalho concluído"
                                    >
                                        <img src="<?php echo htmlspecialchars((string) $foto, ENT_QUOTES, 'UTF-8'); ?>" alt="Trabalho concluído">
                                    </button>
                                <?php endforeach; ?>
                            </div>
